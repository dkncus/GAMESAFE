...
class NetworkTrainer():
	...
	def __init__(self, train_csv, dev_csv, test_csv, save_name, EMBEDDING_MODEL='./models/model.wordvectors', EPOCHS=1, LEARNING_RATE=10e-5, BATCH_SIZE=64, SENTENCE_LENGTH=10, BATCH_DIAGNOSTICS=1, SHOW_STATS=False):
		# Load Dataset
